...
// auto dictionary = getCustomDictionary("ARUCO_MIP_36h12", 250);

// auto chboard = cv::aruco::CharucoBoard::create(5, 8, 0.04, 0.02, dictionary);
// cv::Mat chimg;
// chboard->draw(cv::Size2i(210 * 5, 297 * 5), chimg);
// cv::imwrite("chboard.png", chimg);

// auto board = cv::aruco::GridBoard::create(5, 7, 100, 10, dictionary);
// cv::Mat img;
// chboard->draw(cv::Size2i(210 * 5, 297 * 5), img);

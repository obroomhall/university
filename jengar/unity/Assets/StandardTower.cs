...
public class StandardTower : MonoBehaviour
{
    ...
    private IEnumerator RemoveOneByOneAnalysis()
    {
        ...
        foreach (var block in blocks)
        {
            ...
            //block.score = blocks.Max(b => b.GetMaxDisplacement());
    ...
    void Update()
    {
        ...
        //if (GetMaxDisplacedBlock() > blockLength)
        //{
        ...
        //{
        //    var validBlocks = GetValidBlocks();

        //    if (validBlocks.Count() > 0)
        //    {
        //        int index = rng.Next(validBlocks.Count() - 1);
        //        Destroy(validBlocks.ElementAt(index));
        //    }
        //}

        //if (Input.GetKeyDown(KeyCode.Return))
        //{
        //    foreach (var block in GetValidBlocks())
        //    {
        //        Destroy(block);
        //    }
